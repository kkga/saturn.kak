...
declare-option str green             'rgb:5F875F' #unused
...
declare-option str brwhite           'rgb:DADADA'
...
set-face global function             "%opt{brwhite}+b"
...
set-face global PrimaryCursor        "%opt{bg},%opt{hotpink}+fg"
set-face global SecondaryCursor      "%opt{black},%opt{brblack}+fg"
set-face global PrimaryCursorEol     "%opt{black},%opt{grey}+fg"
set-face global SecondaryCursorEol   "%opt{black},%opt{black}+fg"

set-face global MenuForeground       "%opt{brwhite},%opt{brblack}+b"
